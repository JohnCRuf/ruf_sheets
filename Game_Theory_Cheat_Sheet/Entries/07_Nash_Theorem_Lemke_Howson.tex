\section{Lecture 7: Nash's Theorem and Lemke-Howson Algorithm}
...
\begin{align*}
    F=\{(y,z|y\geq 0, z \geq 0, Mf=1\}
\end{align*} 

and $f=(y,z) \in F$.

\textbf{Add definition giving intuition for what exactly f=(y,z) is.}
...
\subsection{Coincidence of Nash Equilibria Between Degenerate and Preturbed Game}
