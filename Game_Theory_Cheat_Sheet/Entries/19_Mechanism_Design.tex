\section{Lecture 19: Mechanism Design}
...
As a corrolary, if \(\mathcal{M}\) and \(\mathcal{M}'\) implement the same allocation in some BNE for each, and give the same lowest utility to the lowest types, they are revenue equivalent. Examples include
\begin{itemize}
