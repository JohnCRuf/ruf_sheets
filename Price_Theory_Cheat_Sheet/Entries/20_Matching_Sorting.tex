...
\textit{TFU (Core 1993):} in the \textit{final} period before an announced ban, below-MC pricing ends (no future demand left to build) $\implies$ monopoly price \textit{jumps} even with constant $MC$.

\textit{TFU (Final 2000):} a drug making quitting easier has an \textbf{ambiguous} effect on smoking rates: current smokers quit, but lower addiction risk invites new entry.
