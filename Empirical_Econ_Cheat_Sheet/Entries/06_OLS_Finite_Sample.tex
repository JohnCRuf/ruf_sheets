...
\textbf{Note:} TSS $=$ ESS $+$ SSR (hence $0\leq R^2\leq 1$) holds only when the model includes an intercept; without one, $R^2$ may be negative. \\
Adjusted: $\bar{R}^2 = 1 - \frac{n-1}{n-k-1}\cdot\frac{\text{SSR}}{\text{TSS}}\leq R^2$. \\
Population: $R^2_{\text{pop}} = 1 - \frac{\Var(u)}{\Var(y)}$.

High $R^2$ does not imply causality; low $R^2$ does not preclude it.
