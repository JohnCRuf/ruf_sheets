...
With heterogeneous effects and binary $D,Z$, IV does not identify the ATE. Under \textbf{monotonicity} ($D_i(1)\geq D_i(0)$ $\forall i$, no defiers)---which, together with independence and exclusion, is equivalent to (A1)--(A5)---the Wald estimand is the \textbf{LATE}:
\begin{align*}
