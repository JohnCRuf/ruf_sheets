...
\end{align*}
Here $x_i\in\R^{k+1}$ with $x_{i0}=1$. We say the model is ``linear'' because it is linear in the parameters $\beta_j$. The error $u_i$ captures all unobserved determinants of $y_i$.
